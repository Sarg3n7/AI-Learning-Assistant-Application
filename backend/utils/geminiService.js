...
export const generateFlashcards = async (text, count = 10) => {
    ...
    try {
        ...
        throw new Error('Failed to generate flashacrds')
    }
};
...
export const ChatWithContext = async (question, chunks) => {
    ...
    const prompt = `Based on the following context from a document, Analyse the context ans answer the user's question accurately and concisely.
